...
class EvaluationRunner:
    ...
    def __init__(self, evaluators: list[BaseEvaluator]) -> None:
        ...
        Args:
            evaluators: Registered evaluation modules.
        """
        if not evaluators:
    ...
    def evaluate_case(
        ...
        Args:
            ...
            prediction: Generated workflow output.
    ...
    def evaluate_dataset(
        ...
        Args:
            ...
            predictions: Mapping between case IDs and generated outputs.
    ...
    def summarize(self, results: list[CaseEvaluationResult]) -> EvaluationSummary:
        """
        ...
        - LLM Judge metrics: Mean score per dimension
