...
class ExtractionEvaluator(BaseEvaluator):
    ...
    2. Signal polarity:
        - Accuracy over correctly extracted nodes
    """
    ...
    def evaluate(
        ...
        Args:
            ...
            prediction:
                Workflow output containing extracted signals.
        ...
        gold_signals = (
            gold.extraction.active_signals
        )
        ...
        polarity = self._evaluate_polarity(
            gold_signals,
            predicted_signals,
        )
