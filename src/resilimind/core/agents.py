...
def calculate_composite_confidence(
    ...
    The score combines the model self-reported confidence with deterministic
    evidence-density and logical-consistency checks. It is used as a routing
    signal and must not be interpreted as a calibrated probability.

    Weights:
    - 30% model self-reported confidence
    - 30% evidence density
